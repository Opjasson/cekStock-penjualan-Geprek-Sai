            ...
            <Page size="A4" style={styles.page}>
                ...
                <View
                    ...
                    <View
                        ...
                        <Text style={{ fontSize: 12 }}>Date: {new Date()}</Text>
                    </View>
                </View>
                ...
                <View style={{ gap: 5, marginBottom: 70 }}>
                    <View style={{ ...styles.viewBottom, fontSize: 16 }}>
                        ...
                        <Text
                            style={{ ...styles.textBottomItem, fontSize: 25 }}>
                ...
                <View
                    ...
                    <View
                        ...
                        <Text>Owner,</Text>
                        <Image
                            src="/assets/images/ttd-owner.png"
                ...
                <View style={{ textAlign: "center", marginTop: 45 }}>
                    ...
                    <Text>
                        Toko Bunga Anda | +62 812 3456 789 | email123@gmail.com
                    </Text>
                    <Text>
                        Jl. Jend. Sudirman No.44, Pekauman, Kec. Tegal Barat,
